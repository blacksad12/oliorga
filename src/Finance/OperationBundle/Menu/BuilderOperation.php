...
class BuilderOperation extends ContainerAware
{
    /** ************************************************************************
    ...
    protected function addChildList(MenuItem $menu) {
        $menu->addChild('List', array('route' => 'finance_operation_operation_home'))->setAttribute('icon', 'glyphicon-list');
    }
    ...
    protected function addChildNew(MenuItem $menu) {
        $menu->addChild('New Operation', array('route' => 'finance_operation_operation_add'))->setAttribute('icon', 'glyphicon-plus');
    }
    ...
    protected function addChildModify(MenuItem $menu, array $options) {
        $menu->addChild('Modify', array(
                    'route' => 'finance_operation_operation_modify', 
                    'routeParameters' => array('operation_id' => $options['operation']->getId())))
    ...
    protected function addChildDelete(MenuItem $menu, array $options) {
        $menu->addChild('Delete', array('uri' => '#'))
            ...
            ->setLinkAttribute('data-href', $this->container->get('router')->generate('finance_operation_operation_delete', array('operation_id' => $options['operation']->getId())))
            ;
    }
