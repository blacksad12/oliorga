...
class BuilderTransferBetweenAccount extends ContainerAware
{
    /** ************************************************************************
    ...
    protected function addChildList(MenuItem $menu) {
        $menu->addChild('List', array('route' => 'finance_operation_transferbetweenaccount_home'))->setAttribute('icon', 'glyphicon-list');
    }
    ...
    protected function addChildNew(MenuItem $menu) {
        $menu->addChild('New TransferBetweenAccount', array('route' => 'finance_operation_transferbetweenaccount_add'))->setAttribute('icon', 'glyphicon-plus');
    }
    ...
    protected function addChildModify(MenuItem $menu, array $options) {
        $menu->addChild('Modify', array(
                    'route' => 'finance_operation_transferbetweenaccount_modify', 
                    'routeParameters' => array('transferbetweenaccount_id' => $options['transferbetweenaccount']->getId())))
    ...
    protected function addChildDelete(MenuItem $menu, array $options) {
        $menu->addChild('Delete', array('uri' => '#'))
            ...
            ->setLinkAttribute('data-href', $this->container->get('router')->generate('finance_operation_transferbetweenaccount_delete', array('transferbetweenaccount_id' => $options['transferbetweenaccount']->getId())))
            ;
    }
