...
class BuilderAbstractOperation extends ContainerAware
{
    /** ************************************************************************
    ...
    protected function addChildList(MenuItem $menu) {
        $menu->addChild('List', array('route' => 'finance_operation_abstractoperation_home'))->setAttribute('icon', 'glyphicon-list');
    }
    ...
    protected function addChildNew(MenuItem $menu) {
        $menu->addChild('New AbstractOperation', array('route' => 'finance_operation_abstractoperation_add'))->setAttribute('icon', 'glyphicon-plus');
    }
    ...
    protected function addChildModify(MenuItem $menu, array $options) {
        $menu->addChild('Modify', array(
                    'route' => 'finance_operation_abstractoperation_modify', 
                    'routeParameters' => array('abstractoperation_id' => $options['abstractoperation']->getId())))
    ...
    protected function addChildDelete(MenuItem $menu, array $options) {
        $menu->addChild('Delete', array('uri' => '#'))
            ...
            ->setLinkAttribute('data-href', $this->container->get('router')->generate('finance_operation_abstractoperation_delete', array('abstractoperation_id' => $options['abstractoperation']->getId())))
            ;
    }
